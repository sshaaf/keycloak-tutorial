...
Hit the account portal url e.g. *S.*RVER_URL>/auth/realms/demojs/account
e.g. https://sso-evals01-sso-kubernetes-tutorial.apps.cph-5a34.open.redhat.com/auth/realms/demojs/account
