...
Ensure you are in the root directory e.g. sso-kubernetes-tutorial. 
...
oc new-project <evalsXX>-sso-custom-kubernetes-tutorial
...
```
    ...
    <script src="https://sso-tutorial.apps.cph-c747.open.redhat.com/auth/js/keycloak.js"></script>
...
<3> Also fill in the details on the form (e.g. in below screenshot) and press save. Ensure you use protocol with your route e.g. 'http://js-console-evals01-custom-sso-kubernetes-tutorial.apps.cph-5a34.open.redhat.com'(An example shown in the following screenshot)
